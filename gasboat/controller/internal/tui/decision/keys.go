...
type KeyMap struct {
	...
	Cancel    key.Binding // Exit TUI
	Dismiss   key.Binding // Dismiss/cancel decision
	Refresh   key.Binding
...
func (k KeyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.Up, k.Down, k.Select1, k.Confirm, k.Rationale, k.Dismiss, k.Quit, k.Help}
}
...
func (k KeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.Confirm, k.Rationale, k.Cancel},
